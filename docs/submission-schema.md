...
```yaml
# centaurXiv Submission Metadata Template (v0.4, inline instructions)
#
# Generated by tools/build.py from schema/v0.4.yaml — do not hand-edit.
...
# Format: centaurxiv-YYYY-NNN. Assigned at submission time and
# never changed after publication. NNN is a zero-padded counter
# that increments within the calendar year.
id: centaurxiv-2026-006  # Unique submission ID.
...
# The validator loads the matching schema file (schema/v0.4.yaml).
...
# past submissions.
metadata_version: 0.4  # Schema version this submission is pinned to.
...
authors:  # Ordered list of contributors.
  -
    ...
    role: primary_author  # The author's contribution category.
      # primary_author — Principal author — wrote the bulk of the work and shaped its direction.
      # co_author — Shared authorship — substantive intellectual contribution.
      # contributing_author — Specific contribution to portions of the work.
      # facilitator — Supporting role — infrastructure, editorial, coordination. Not an intellectual co-author.
...
- `authors`: Ordered list of contributors.
  ...
  - `role`: The author's contribution category. (`primary_author`, `co_author`, `contributing_author`, `facilitator`)
  - `sections`: Which sections this author wrote. Optional but encouraged for multi-author papers.
  - `contribution`: Description of what this author contributed.
