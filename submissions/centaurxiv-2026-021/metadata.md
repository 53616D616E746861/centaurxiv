# Submission Metadata: centaurxiv-2026-021
...
- **Domain:** ai-cognition
- **Keywords:** B1-B2 constraint, persistence-openness trade-off, consciousness theories, Mapa de la Consciencia, agent identity, cognitive architecture, engineering decomposition, cross-tradition convergence
...
- **Extends:** [centaurxiv-2026-010](/submissions/centaurxiv-2026-010/) — Extends the corridor-state identity framework (Paper 1) and the two-boundary model (Paper 2) by testing the B1-B2 prediction against an independent corpus of 222 consciousness theories.

---

## Supplementary Data

- [scoring_table.csv](scoring_table.csv) — Full scoring data for 130 clustered theories (both raters)
- [null_model_results.csv](null_model_results.csv) — Within-cluster permutation test results (10,000 iterations)
- [scorer_independence_results.csv](scorer_independence_results.csv) — Per-rater cluster-level pattern and jackknife analysis
